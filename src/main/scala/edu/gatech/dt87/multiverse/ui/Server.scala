...
case class Server(state: State, goalSet: Set[Goal[State, SymbolMap, SymbolMap]]) {
  ...
  var goalForId: Map[String, Goal[State, SymbolMap, SymbolMap]] = Map[String, Goal[State, SymbolMap, SymbolMap]]()
  var stateForId: Map[String, State] = Map[String, State]()
  var idForState: Map[State, String] = Map[State, String]()
  var idForGoal: Map[Goal[State, SymbolMap, SymbolMap], String] = Map[Goal[State, SymbolMap, SymbolMap], String]()
  var iterator: Iterator[Int] = Iterator.from(0)
