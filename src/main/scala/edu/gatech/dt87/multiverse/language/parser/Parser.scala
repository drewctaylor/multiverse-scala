...
object Parser extends TokenParsers with LexerTokens {
    ...
    /**
      ...
      */
    lazy val declarationStory: Parser[DeclarationStory] = opt(lexical.TokenKeywordStory ~ literalString ~ opt(literalNumber)) ~ opt(declarationState) ~ rep(declarationGoal) ^^ {
    ...
    /**
      ...
      */
    lazy val blockState: Parser[List[StatementAssignmentQualified]] = lexical.TokenKeywordBraceLeft ~ rep(statementAssignmentQualifiedList) ~ lexical.TokenKeywordBraceRight ^^ {
    ...
    /**
      ...
      */
    lazy val declarationGoal: Parser[DeclarationGoal] = lexical.TokenKeywordGoal ~ identifierPart ~ lexical.TokenKeywordParenthesesLeft ~ opt(parameterList) ~ lexical.TokenKeywordParenthesesRight ~ opt(literalString) ~ blockGoal ^^ {
    ...
    /**
      ...
      */
    lazy val blockGoal: Parser[Set[DeclarationStrategy]] = lexical.TokenKeywordBraceLeft ~ rep(declarationStrategy) ~ lexical.TokenKeywordBraceRight ^^ {
    ...
    /**
      ...
      */
    lazy val declarationStrategy: Parser[DeclarationStrategy] = lexical.TokenKeywordStrategy ~ opt(literalString) ~ blockStrategy ^^ {
    ...
    /**
      ...
      */
    lazy val blockStrategy: Parser[List[Statement]] = lexical.TokenKeywordBraceLeft ~ rep(statementSubgoal | statementQuery | statementAssignmentQualifiedList | statementNarration) ~ lexical.TokenKeywordBraceRight ^^ {
        case _ ~ sll ~ _ => sll.flatten
    }
