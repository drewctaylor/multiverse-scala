 ...
 */
case class DeclarationGoal(identifier: Symbol, label: Option[ExpressionLiteralString], parameterList: List[DeclarationParameter], block: BlockGoal) extends Declaration
 ...
 */
case class DeclarationParameter(kind: Symbol, parameter: Symbol) extends Declaration
...
/**
 * A relationship declaration consists of relationship and the attributes associated with the relationship.
 *
...
/**
 * An entity declaration consists of the kind of the entity, the entity identifier, and the attributes associated with
 * the entity.
 *
 * @param kind the kind of the entity
 ...
 */
case class DeclarationEntity(kind: Symbol, entity: ExpressionEntity, block: BlockAssignment) extends DeclarationData
